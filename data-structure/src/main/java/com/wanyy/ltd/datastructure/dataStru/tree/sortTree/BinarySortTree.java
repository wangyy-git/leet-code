package com.wanyy.ltd.datastructure.dataStru.tree.sortTree;
...
class SortNode{
    ...
    public void infix(int[] array){
        if (this.left != null) this.left.infix(array);
        System.out.println(this);
        array[index++] = this.value;
        if (this.right != null) this.right.infix(array);
    }
